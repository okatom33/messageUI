...
(function () {
  ...
  var DropDown = function ($) {
    ...
    _checkWindow = function _checkWindow() {
  ...
  var Modal = function ($) {
    ...
    _scrollStart = function _scrollStart() {
      $('body').removeClass('js-no-scroll');
    };
    _position = function _position(posY, target) {
  ...
  var Tooltip = function ($) {
    ...
    _clickNotice = function _clickNotice() {
    ...
    _clickMessage = function _clickMessage() {
    ...
    _clickAcount = function _clickAcount() {
  ...
  var AddCareer = function ($) {
    ...
    _deleteEvent = function _deleteEvent() {
